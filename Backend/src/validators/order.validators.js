...
// FIX: Changed logic to correctly handle conditional requirement
const limitPriceSchema = Joi.number()
    ...
    .when('orderType', {
        is: 'LIMIT',
        then: Joi.required(), // ✅ Fixed: Must be a function call Joi.required()
        otherwise: Joi.optional().allow(null) // ✅ Fixed: Allow null/undefined for MARKET orders
    })
    .messages({
        'number.base': 'Limit must be a number',
        'number.positive': 'Limit price must be greater than 0',
        'number.max': 'Limit price cannot exceed 1000000',
